...
export default function Sidebar({ onMeasurementsChange }: SidebarProps) {
  ...
  return (
    <div className="w-80 bg-gradient-to-br from-purple-50 to-white shadow-lg p-6 flex flex-col">
      <div className="flex items-center space-x-4 mb-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">My Measurements</p>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          <button 
            onClick={handleSave}
            className="w-full bg-gradient-to-r from-violet-600 to-purple-600 text-white py-2.5 rounded-lg hover:from-violet-700 hover:to-purple-700 transition-all duration-300 font-medium shadow-md hover:shadow-lg flex items-center justify-center gap-2"
          >
          ...
          <button 
            onClick={handleReset}
            className="w-full bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 py-2.5 rounded-lg hover:from-gray-200 hover:to-gray-300 transition-all duration-300 font-medium shadow-sm hover:shadow-md flex items-center justify-center gap-2 border border-gray-200"
          >
