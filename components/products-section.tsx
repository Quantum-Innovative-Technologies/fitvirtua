          ...
          {categories.map((category) => (
            <button
              ...
              className={`rounded-full px-6 py-2 whitespace-nowrap ${
                selectedCategory === category ? "bg-black text-white" : "bg-white text-gray-800 hover:bg-gray-100"
              }`}
            >
            ...
            <div key={product.id} className="group relative">
              <div className="aspect-w-3 aspect-h-4 overflow-hidden rounded-lg bg-gray-100">
                ...
                <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button className="rounded-full bg-white p-2 shadow-lg hover:bg-gray-100">
              ...
              <div className="mt-4">
                ...
                <button
                  ...
                  className="rounded-full mt-2 w-full bg-black text-white py-2 hover:bg-gray-900 transition-colors"
                >
                  Add to Cart
                </button>
              </div>
